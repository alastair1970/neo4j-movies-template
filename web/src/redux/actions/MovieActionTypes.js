...
export const MOVIE_RATE_FAILURE            = 'OVIE_RATE_FAILURE';
...
export const SET_MOVIE_STATE_SUCCESS       = 'SET_MOVIE_STATE_SUCCESS';
export const SET_MOVIE_STATE_FAILURE       = 'SET_MOVIE_STATE_FAILURE';
