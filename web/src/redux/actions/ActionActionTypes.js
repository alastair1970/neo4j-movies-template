...
export const SET_ACTION_FAILURE       = 'SET_ACTION_FAILURE';

export const SAV_ACTION               = 'SAV_ACTION';
export const SAV_ACTION_SUCCESS       = 'SAV_ACTION_SUCCESS';
export const SAV_ACTION_FAILURE       = 'SAV_ACTION_FAILURE';
